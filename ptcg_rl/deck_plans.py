...
PLANS: dict[str, DeckPlan] = {
    ...
    "Mega Lucario": DeckPlan(
        ...
        setup_basics=(333, 673, 676, 675),
        evolution_chain=(333, 678, 673, 674),
        engine_cards=(676, 675),
        notes=(
            "Sample-limited specialist. Correct deck signature and score bands are mandatory.",
            "Failure reports show MAIN, ATTACH_FROM, and TO_HAND still drive most errors.",
        ),
    ),
    "Alakazam": DeckPlan(
        archetype="Alakazam",
