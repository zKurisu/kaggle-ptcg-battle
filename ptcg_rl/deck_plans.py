...
PLANS: dict[str, DeckPlan] = {
    ...
    "Teal Mask Ogerpon": DeckPlan(
        ...
        secondary_attackers=(978, 63, 117, 108, 386, 756, 1071, 272),
        setup_basics=(96, 978, 63, 184, 117, 108, 386, 756, 1071, 272, 140),
        engine_cards=(96, 1071, 756, 184, 386),
        energy_accel=(96, 1116, 1098, 1198),
        draw_search=(1071, 1121, 1205),
        stadium_tools=(1250,),
        disruption=(1182, 1197),
        switching=(184, 1088),
        notes=(
            ...
            "Into Crustle, 2a-style lists should preserve Passimian, build a wide Basic board, and attack early.",
            "Cornerstone/Demolish and Wellspring bench pressure are alternate routes, not replacements for Passimian in 2a.",
        ),
    ),
    ...
    "Alakazam": DeckPlan(
        ...
        engine_cards=(742,),
        draw_search=(742, 1079, 1086, 1152, 1225, 1231),
        disruption=(1081, 1182, 1197),
        stadium_tools=(1266,),
        notes=(
    ...
    "Dragapult": DeckPlan(
        ...
        secondary_attackers=(112, 133, 132, 235, 1071),
        setup_basics=(119, 131, 235, 140, 1071),
        evolution_chain=(119, 120, 121, 131, 132, 133),
        engine_cards=(120, 112, 131, 132, 133, 235, 140, 1071),
        energy_accel=(1198,),
        draw_search=(120, 1086, 1121, 1152, 1227, 1231),
        disruption=(1120, 1182, 1080, 1213, 1246, 1256),
        notes=(
            "Stage-2 spread plan. Set up Dreepy/Drakloak before committing Dragapult ex.",
            "Use Drakloak draw while it is still Drakloak, then evolve when the payoff route is ready.",
            "Phantom Dive bench counters should build a prize map with Dusknoir/Munkidori, not only overkill one target.",
